...
<pre>gte(a: <a href="https://docs.kaskada.com/docs/data-model#type-constraints">ordered</a>, b: <a href="https://docs.kaskada.com/docs/data-model#type-constraints">ordered</a>) -> bool</pre>
